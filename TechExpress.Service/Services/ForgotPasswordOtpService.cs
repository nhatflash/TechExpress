...
namespace TechExpress.Service.Services.Otp
{
    public class ForgotPasswordOtpService
    {
        ...
        public ForgotPasswordOtpService(RedisUtils redis)
        {
            _redis = redis;
        }
        ...
        public async Task VerifyOrThrowAsync(string email, string otpInput)
        {
            ...
            try
            {
                payload = JsonSerializer.Deserialize<ForgotPasswordOtpCache>(json)
